...
describe('Button', () => {
  ...
  it('Should render an anchor', ()=> {
    ...
    expect(screen.getByRole('link')).toHaveClass('button button--default undefined undefined')
    expect(screen.getByRole('link', { name: 'My Anchor Button' })).toBeInTheDocument()
  })
  ...
  it('Should render a route link', ()=> {
    ...
    expect(screen.getByRole('link')).toHaveClass('button button--default undefined undefined')
    expect(screen.getByRole('link', { name: 'My Link Button' })).toBeInTheDocument()
  })
})